...
# to evaluate metrics for chainer trained model and get metrics result easier.
...
try:
    # Monkey patch in our own evaluate, which supports chainer
    import evaluate
...
#    print(f"Evaluating Experiment '{experiment_name}' from {base_path}.")
    ...
    exp_config = utils_chainer.get_config()
